  ...
  
{
  ...
  DATA_SPARSE_MATRIX(A_anc_aggregation);
  DATA_SPARSE_MATRIX(A_admin1_births);
  DATA_SPARSE_MATRIX(A_sisma_age);
  ...
  vector<Type> births_admin1_anc_age = A_anc_aggregation * births_full;
  vector<Type> births_admin1 = A_admin1_births * births_full;
  vector<Type> births_admin1_expected_anc = A_sisma_age * births_admin1;
  
  // nll -= dpois(births_admin1_expected_anc, births_admin1_anc_age, true).sum();
